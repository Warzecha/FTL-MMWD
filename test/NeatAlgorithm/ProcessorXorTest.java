...
//        genome.addConnectionGene(c7);
    ...
    void evaluateNetworkWithInputOfZeros() {
        ...
        List<Double> expected = new ArrayList<Double>(Arrays.asList(0.0));
    ...
    @Test
    void evaluateNetworkWithNormalInput() {
        List<Double> input = new ArrayList<Double>(Arrays.asList(1.0, 0.0));
        List<Double> expected = new ArrayList<Double>(Arrays.asList(0.5));
